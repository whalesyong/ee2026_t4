...
## - Rename the used ports (after get_ports) according to the top-level signal names in your project.
...
## Pmod Header JA (Not used - commented out)
...
## Pmod Header JC (Not used - commented out)
...
## Pmod Header JXADC (Not used - commented out)
...
## VGA Connector (Not used - commented out)
...
## USB-RS232 Interface (Not used - commented out)
...
## Quad SPI Flash (Not used - commented out)
